            ...
            <div className="relative w-full max-w-[1200px] px-6 text-center">
                ...
                <div className="flex justify-center -mt-5 gap-4">
                    {testimonials.map((t, i) => (
                        <div
                            key={i}
                            className={`z-10 relative w-14 h-14 rounded-2xl border-4 border-white shadow-md overflow-hidden transition-all duration-500 ${i === activeIndex ? "scale-110" : "opacity-70"
                                }`}
                        >
