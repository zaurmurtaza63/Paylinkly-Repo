...
const Home = () => {
    ...
    return (
        <>
            {/* HERO SECTION */}
            <section
                className={`hero-bg-img pt-[150px] h-screen relative w-full flex flex-col items-center justify-center text-center px-6 md:px-8 py-24 transition-all duration-1000 ease-out ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                    }`}
                style={{
            ...
            <section ref={counterRef} className="counter-section">
                <div
                    className={`max-w-[1200px] mx-auto px-6 md:px-10 text-center grid grid-cols-1 sm:grid-cols-3 gap-10 transition-all duration-1000 ease-out ${isCounterVisible
                            ? "opacity-100 translate-y-0"
                            : "opacity-0 translate-y-10"
                        }`}
                >
            ...
            >
                <div>
                    ...
                    >
                        ...
                        <div className="px-5 gap-7 container grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 lg:my-10 my-5">
                            ...
                            <div className="flex items-center gap-1.5 justify-center">
                                <img src={ frausIcon} alt="powerIcon" />
                                <p className="gradient-text text-[18px] font-medium">
                               Get approved in 48 hours
                            </p>
                            </div>
                            <div className="flex items-center gap-1.5 justify-center">
                                <img src={increaseIcon} alt="powerIcon" />
                                <p className="gradient-text text-[18px] font-medium">
                               Get approved in 48 hours
                            </p>
                            </div>
                        </div>
                        <button className="flex items-center justify-center gap-2.5 blue-btn max-w-fit hover:-translate-y-0.5 hover:shadow-lg hover:cursor-pointer transition-all duration-300 text-white font-bold">
